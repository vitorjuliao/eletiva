...
function findAndClickByClass(className) {
    ...
    if (element) {
        ...
        if (element.textContent === 'Mostrar resumo') {
            sendToast("🎉 Vitin fez seu exercício!", 3000);
...
function spoofQuestion() {
    const phrases = [
        "🎮💣 Khan Destroyer Feito por Vitin do capa e CBUM(https://discord.gg/gamesdest)!",
        "❓ Made by [Vitin](https://guns.lol/iunknownbr).",
        "🏂 Made by [Cbum](https://guns.lol/imsnow)"
    ];
...
loadScript('https://cdn.jsdelivr.net/npm/toastify-js').then(async () => {
    sendToast("🎮 Khan Destroyer injetado com sucesso by vitin!", 5000, 'bottom');
